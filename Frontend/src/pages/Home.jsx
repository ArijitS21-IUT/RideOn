...
const Home = () => {
  return (
    <div>
      <div className='bg-cover bg-bottom bg-top bg-[url(/home/arijit/Desktop/RideOn/Frontend/src/assets/Home.png)] h-screen pt-8 flex justify-between flex-col w-full bg-red-400'>
